...
export function UserManagementPage() {
  ...
  const canManageUsers = isSystemAdministrator || (currentUser?.role_codes?.includes("administrator") ?? false);
  ...
  const canEditUser = (managedUser: ManagedUser): boolean => managedUser.id !== currentUser?.id && (isSystemAdministrator || !managedUser.role_codes.some((roleCode) => ["administrator", "system_administrator"].includes(roleCode)));
